  ...
  return (
    <>
      ...
      <div className="max-w-3xl pb-12 mx-auto text-center">
        ...
        <AuthLogo />
        { /* Page title */}
        <h1 className="text-transparent h2 bg-clip-text bg-gradient-to-r from-revocalize-200/60 via-revocalize-100 to-revocalize-200/60">Create your free account</h1>
      </div>
      ...
      <div className="max-w-sm mx-auto">
        ...
        <form>
          <div className="space-y-4">
            <div>
              <label className="block mb-1 text-sm font-medium text-slate-300" htmlFor="company">Company <span className="text-rose-500">*</span></label>
              <input id="company" className="w-full form-input" type="text" placeholder="mE.g., Acme Inc." required />
            </div>
            <div>
              <label className="block mb-1 text-sm font-medium text-slate-300" htmlFor="full-name">Full Name <span className="text-rose-500">*</span></label>
              <input id="full-name" className="w-full form-input" type="text" placeholder="E.g., Mark Rossi" required />
            </div>
            <div>
              <label className="block mb-1 text-sm font-medium text-slate-300" htmlFor="email">Email <span className="text-rose-500">*</span></label>
              <input id="email" className="w-full form-input" type="email" placeholder="markrossi@company.com" required />
            </div>
            <div>
              <label className="block mb-1 text-sm font-medium text-slate-300" htmlFor="password">Password <span className="text-rose-500">*</span></label>
              <input id="password" className="w-full form-input" type="password" autoComplete="on" required />
            </div>
            <div>
              <label className="block mb-1 text-sm font-medium text-slate-300" htmlFor="referrer">Where did you hear about us? <span className="text-rose-500">*</span></label>
              <select id="referrer" className="w-full py-2 text-sm form-select" required>
        ...
        <div className="flex items-center my-6">
          <div className="mr-3 border-t border-slate-800 grow" aria-hidden="true" />
          <div className="text-sm italic text-slate-500">or</div>
          <div className="ml-3 border-t border-slate-800 grow" aria-hidden="true" />
        </div>
