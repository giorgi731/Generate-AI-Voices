...
import { Edit3Icon, EditIcon, PlusIcon } from 'lucide-react';
  ...
  return (
    <>
      ...
      >
        ...
        <SelectContent
          position={'popper'}
          className="w-full px-[12px] py-[20px]"
        >
          <SelectArrow />
          <p className="text-[#FFFFFFCC] text-sm px-3">{userInfo?.data?.displayName}</p>
          <p className="text-[#B2B2B2] text-xs px-3">{userSession?.auth?.user?.email}</p>
          ...
          <button className='flex flex-row items-center py-2 px-3 hover:bg-[#FFFFFF0D] rounded-[8px]'>
            <Edit3Icon size={20} />
            <p className='text-sm text-[#FFFFFF99] ml-2'>Edit Account</p>
          </button>
          <button className='flex flex-row items-center py-2 px-3 !mt-3 hover:bg-[#FFFFFF0D] rounded-[8px]'>
            <CogIcon size={20} />
            <p className='text-sm text-[#FFFFFF99] ml-2'>Manage Subscriptions</p>
          </button>
          <button className='flex flex-row items-center py-2 px-3 !mt-3 hover:bg-[#FFFFFF0D] rounded-[8px]'>
            <LogOutIcon size={20} />
            <p className='text-sm text-[#FFFFFF99] ml-2' onClick={signOut}>Sign out</p>
          </button>
          {/* <p className="text-[#AAADB3]">Jacob</p>
          <Link
            href="/ai-voice-generator"
            className="!mt-[12px] flex flex-row items-start"
          >
            ...
            <span className="ml-[10px]">
              ...
              <p className="hover:text-white-95 text-[13px] text-[#AAADB3]">
                Edit workspace
              </p>
            </span>
          </Link>
          ...
          >
            ...
            <span className="ml-[10px]">
              ...
              <p className="text-[13px] text-[#AAADB3]">Manage collaborators</p>
            </span>
          </Link>
          <Link
            href="/ai-voice-generator"
          ...
          >
            ...
            <span className="ml-[10px]">
              <span className="text-white hover:text-white/75">
                <Trans i18nKey={'common:inviteCollaborators'} />
              </span>
              <p className="text-[13px] text-[#AAADB3]">Add new members</p>
            </span>
          </Link> */}
        </SelectContent>
      </Select>
