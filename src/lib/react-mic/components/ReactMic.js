...
import { FingerprintIcon, History, LoaderIcon, MicIcon, SunIcon, UploadIcon } from "lucide-react"
  ...
  render() {
    ...
    return (
      <canvas
        ...
        className={`visualizer max-w-screen ${this.props.className} max-w-xs`}
      />
    );
  }
}
...
ReactMic.defaultProps = {
  ...
  strokeColor: "#000000",
  className: "visualizer",
  audioBitsPerSecond: 128000,  mimeType: "audio/webm;codecs=opus",
  record: false,
  width: 640,
  height: 100,
