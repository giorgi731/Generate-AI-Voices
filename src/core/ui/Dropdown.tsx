    ...
    <DropdownMenuPrimitive.Content
      ...
      className={classNames(
        'animate-in data-[side=bottom]:slide-in-from-top-2 w-screen md:w-auto' +
          ...
          ' bg-white p-1 shadow-xl dark:border-black-200 dark:bg-[#2B2041]' +
...
>(({ className, inset, clickable = true, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={classNames(
      'relative flex h-full w-full select-none items-center rounded-md' +
        ' px-2 text-sm font-medium outline-none focus:outline-none' +
        ' data-[disabled]:pointer-events-none data-[disabled]:opacity-50',
      {
        'pl-8': inset,
        [`transition-colors focus:bg-[#2B2041] active:bg-[#2B2041]  bg-[#2B2041] dark:active:bg-black-100`]:
          clickable,
      },
      className
    )}
