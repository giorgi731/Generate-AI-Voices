  ...
  return (
    <section className="relative">
      <div className="relative max-w-6xl px-4 mx-auto sm:px-6">
        ...
        { /* Blurred shape */}
        <div className="absolute top-0 left-0 -mt-24 -ml-16 pointer-events-none blur-2xl opacity-70 -z-10" aria-hidden="true">
        ...
        <div className="pt-16 pb-12 md:pt-32 md:pb-20">
          ...
          <div className="max-w-3xl pb-12 md:pb-20">
            <h2 className="pb-4 text-transparent h2 bg-clip-text bg-gradient-to-r from-revocalize-200/60 via-revocalize-100 to-revocalize-200/60">Why trust us?</h2>
          ...
          <div className="divide-y divide-slate-800">
            ...
            <div className="py-8 first-of-type:pt-0 last-of-type:pb-0">
              <div>
                <div className="inline-flex pb-6 font-medium text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-purple-200">API Authorization</div>
              </div>
              <div className="mb-2 grid md:grid-cols-3 gap-8 md:gap-12">
                { /* Feature */}
                <div>
            ...
            <div className="py-8">
              <div>
                <div className="inline-flex pb-6 font-medium text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-purple-200">User Management</div>
              </div>
              <div className="mb-2 grid md:grid-cols-3 gap-8 md:gap-12">
                { /* Feature */}
                <div>
            ...
            <div className="py-8">
              <div>
                <div className="inline-flex pb-6 font-medium text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-purple-200">Standard Security</div>
              </div>
              <div className="mb-2 grid md:grid-cols-3 gap-8 md:gap-12">
                { /* Feature */}
                <div>
