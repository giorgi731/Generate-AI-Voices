...
export default function Footer() {
  return (
    <footer>
      <div className="max-w-6xl px-4 mx-auto sm:px-6 font-system">

        { /* Blocks */}
        <div className="py-8 grid sm:grid-cols-12 gap-8 md:py-12">

          { /* 1st block */}
          <div className="order-1 sm:col-span-12 lg:col-span-4 lg:order-none">
            <div className="flex flex-col justify-between h-full sm:flex-row lg:flex-col">
              ...
              <ul className="flex mt-5">
                <li>
                  <a className="flex items-center justify-center text-revocalize-500 hover:text-revocalize-400 transition duration-150 ease-in-out" href="#0" aria-label="Twitter">
                ...
                <li className="ml-2">
                  <a className="flex items-center justify-center text-revocalize-500 hover:text-revocalize-400 transition duration-150 ease-in-out" href="#0" aria-label="Dev.to">
                ...
                <li className="ml-2">
                  <a className="flex items-center justify-center text-revocalize-500 hover:text-revocalize-400 transition duration-150 ease-in-out" href="#0" aria-label="Github">
                    <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
          ...
          { /* 4th block */}
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
            <h6 className="mb-2 text-sm font-medium text-slate-50">Resources</h6>
            <ul className="text-sm space-y-2">
              <li>
