    ...
    return (
      <div
        className={classNames(
          `active-within:ring-2 relative flex w-full items-center
        rounded-lg border border-gray-200 bg-white font-[400] font-custom 
        ...
        dark:hover:border-gray-300 dark:focus:bg-black-400 lg:text-sm dark:bg-transparent text-white`,
          className,
          {
      ...
      >
        ...
        <input
          {...props}
          className={classNames(
            `h-10 flex-1 rounded-lg bg-transparent px-3 py-4 text-white outline-none disabled:cursor-not-allowed disabled:opacity-30`,
            className
          )}
          ref={ref}
        />
