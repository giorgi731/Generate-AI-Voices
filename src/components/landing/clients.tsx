      ...
      <div className="relative max-w-6xl px-4 mx-auto sm:px-6">
        ...
        <div className="py-12 md:py-16">
          <div className="overflow-hidden">
            ...
            <div className="relative clients-carousel swiper-container before:absolute before:inset-0 before:w-32 before:z-10 before:pointer-events-none before:bg-gradient-to-r before:from-revocalize-950 after:absolute after:inset-0 after:left-auto after:w-32 after:z-10 after:pointer-events-none after:bg-gradient-to-l after:from-revocalize-950">
