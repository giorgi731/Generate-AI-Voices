  ...
  return (
    <>
      ...
      <div className="max-w-3xl pb-12 mx-auto text-center">
        ...
        <AuthLogo />
        { /* Page title */}
        <h1 className="text-transparent h2 bg-clip-text bg-gradient-to-r from-revocalize-200/60 via-revocalize-100 to-revocalize-200/60">Sign in to your account</h1>
      </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              <div className="flex justify-between">
                <label className="block mb-1 text-sm font-medium text-slate-300" htmlFor="password">Password</label>
                <Link className="ml-2 text-sm font-medium text-purple-500 hover:text-purple-400 transition duration-150 ease-in-out" href="/reset-password">Forgot?</Link>
              </div>
