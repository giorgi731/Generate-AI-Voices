...
const DarkModeToggle = () => {
  ...
  return (
    <Select value={currentTheme} onValueChange={setCurrentTheme}>
      <SelectTrigger asChild aria-label='Toggle dark mode'>
        <IconButton
      ...
      <SelectContent position={'popper'} sideOffset={5}>
        ...
        <SelectItem data-cy={'dark-theme-button'} value={DARK_THEME_CLASSNAME} aria-label='Toggle dark mode'>
          <span className={'flex items-center space-x-2.5'}>
            <MoonIcon className={'h-4'} aria-label='Toggle dark mode' />
